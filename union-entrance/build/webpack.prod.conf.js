...
var getPlugin = function () {
    var plugin = [
        ...
        new HtmlWebpackPlugin({
            ...
            //     ? 'page/index.html'
            //     : config.build.index,
            filename: utils.assetsPath('page/index.html'),
            template: path.join(config.dev.page, 'index.html'),
            inject: true,
            minify: {
                removeComments: true,
...
var webpackConfig = merge(baseWebpackConfig, {
    ...
    output: {
        ...
        publicPath: env === 'dev' ? config.dev.assetsPublicPath : config.build.assetsPublicPath,
