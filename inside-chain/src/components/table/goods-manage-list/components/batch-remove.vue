...
export default {
    ...
    methods: {
        ...
        batchRm(){
            ...
            // this.getBatchRemoveChainShopItemResult({
            //     params:{
            //     industry:0,
            //     req:JSON.stringify({opRecordId:'445178076322709968'})
            //     },
            //     VM:this
            //     })
        },
        ok(){
            ...
            this.$Modal.confirm({
                ...
                render: (h) => {
                    return h('div',{style:{height:'40px',padding:'18px 0 0 48px'}},[
                        h('p',{style:{fontSize:'14px'}},[
                            h('span',{style:{color:'#3366ff',margin:'0 5px 0 0'}},this.item.itemName),
                            h('span','将在'),
                ...
                onOk: () => {
                    ...
                    this.batchChainShopModify({params:this.params,VM:this})
                    this.checkGroup = []
                    this.value = ""
                },
                onCancel: () => {
