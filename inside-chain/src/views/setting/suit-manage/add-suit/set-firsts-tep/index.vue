...
<script>
    ...
    import MenuSet from '@/components/goods-detail/menu-set.vue'
    ...
    export default {
        ...
        computed: {
            ...
            routerPath(){
                ...
                return {path: 'add_set_combo_goods', query: {plateEntityId}}
            },
            cateGoryPath(){
                return {
                    path: '/goods_class',
            ...
            nextPath(){
                ...
                this.$nextTick(() => {
                    ...
                    if (baseInfo && suitShow) {
                        ...
                        this.detailBaseInfoToBack.callback = (itemId) => {
                            this.routerPath.query.itemId = itemId
