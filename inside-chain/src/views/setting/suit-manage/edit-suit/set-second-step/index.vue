<template>
    <div class="shop-wrap">
        ...
        <baseSteps :current="current" class="mb-20px base-step">
        ...
        <div class="suit-group">
            ...
            <div v-for="(item, $index) in suitGroups" :key="$index">
                <table-group-list :max-num="item.num"
                                  :name="item.name"
                                  :suit-index="item.suitIndex"
                                  :is-required="item.isRequired"
                                  :table-data="item.itemList"
                                  v-show="item.isValid"
        ...
        <div class="bottom">
            <router-link :to="preRoute" class="btn-pre">
                返回上一步
            </router-link>
