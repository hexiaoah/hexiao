<template>
    <div>
            <BaseCard class="mb-20px">
                ...
                <Row class="mt-20px">
                    <Col :md="24" class="block">
                    <PassBlock :info="taskInfo.passInfo"></PassBlock>
                    </Col>
                </Row>
...
<script>
    ...
    import PassBlock from './pass-module'
...
//                        下发模块类型为传菜
                        moduleType: '2',
                        oldTaskId: self.pageParams.taskId,
                        name: self.taskName,
                        publishTime: self.formatDateTime,
                        timeType: self.timeType,
                        plateEntityId: self.taskInfo.plateEntityId,
