        ...
        <div class="content">
            ...
            <div class="forth-level">
                <Breadcrumb class="break">
                    ...
                    <BreadcrumbItem to="" class="disable-color">添加套餐</BreadcrumbItem>
                </Breadcrumb>
            </div>
    ...
    export default {
        ...
        computed: {
            ...
            routerPath(){
                ...
                return {path: 'single_suit_add_second_step', query: {crumbName, entityId}}
            },
            suitManageRoute(){
                let crumbName = this.$route.query.crumbName
                let entityId = this.$route.query["entityId"] || ""
...
//            this.setNav(2)
            ...
            // 获取分类列表
            let { itemId, entityId } = this.$route.query
