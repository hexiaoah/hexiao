export class loading {
    ...
    _onlyLoadingStart(loadingConfigOnly) {
        ...
        let top = this._getPositionTop(loadingDomWrapper);
        let left = this._getPositionLeft(loadingDomWrapper);
        let width = loadingDomWrapper.offsetWidth;
        let height = loadingDomWrapper.offsetHeight;
        ...
        if (loadingDom) {
            ...
            this._addStyle({...loadingConfigOnly, top, left, width, height});
        }
    ...
    _onlyLoadingEnd(loadingConfigOnly) {
        ...
        let num = Number(loadingDom.getAttribute('data-num')) - 1;
        loadingDom.setAttribute('data-num', num);
        if (num > 0) {
            return false;
        }
        ...
        let minShowTime = loadingConfigOnly.minShowTime || this.config.minShowTime;
        if (time >= minShowTime) {
    ...
    loadingStart(loadingConfigOnly) {
        ...
        if (this.config.loadDOM) {
            ...
            this._addDom(this.config, function () {
