<template>
    <div class="scan-wrapper">
        ...
        <div class="top-wrapper">
            ...
            <div class="title">请扫描下方二维码签约</div>
        </div>
        ...
        <div class="qr-code" :style="'background: url(' + this.signUrl + ') center center / contain no-repeat;'"></div>
        <div class="download"  @click="downloadQrCode">下载到手机</div>
 
        <div class="footer">
            <div class="align-center btn">
                <button class="footer-button" @click="querySingFinished">签约成功</button>
            </div>
        </div>
    </div>
</template>
