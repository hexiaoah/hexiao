    ...
    return(
      items.map((item, index) =>
        <div className={style.picturEdit}>
          ...
          />
          {config.mode !== '文字导航' && <div onClick={(e)=>this.onChangeBtn(index, e)} className={cx(style.uploadBtn, 'desigeCove')} style={{backgroundImage:`url(${item.picture ? item.picture : defaultImg})`}}/> }
