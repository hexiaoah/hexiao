...
import style from './TmpUploadChoose.css'
...
export default class imgUploadPreview extends PureComponent {
  ...
  imgListPriew = () => {
    const { selectionIndex, imgList, totalPage } =  this.state
    return(
      <div>
        ...
        <Pagination onChange={this.onPagina} className={style.uploadPagination}  defaultCurrent={1} total={totalPage * 10} />
      </div>
    )
  }
