...
import style from './SeachEditor.css'
        ...
        return (
            <div className={`${prefix}-design-component-line-editor`}>
              <div className={style.componentTitleEditor}>
                ...
                <RadioGroup value={value.config.shape} className={style.controlGroupControl} onChange={(e) => this.onChange('shape', e)}>
              ...
              <div className={style.componentTitleEditor}>
                ...
                <RadioGroup value={config.textAlign} className={style.controlGroupControl} onChange={(e) => this.onChange('textAlign', e)}>
