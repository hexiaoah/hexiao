...
import style from './myEditor.css'
            ...
            <div className={style.member_editor_container}>
                ...
                <div className={style.member_icons_box}>
                    <div className={style.member_flex_icon}>
                        <div className={style.member_title}>会员中心：</div>
                        <div className={style.member_upload} onClick={() => this.onChangeBtn('会员中心')}>
                            <img src={icons['会员中心']} alt=""/>
                        </div>
                    </div>
