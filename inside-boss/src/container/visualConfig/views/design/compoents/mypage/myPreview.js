...
import style from './myPreview.css'
            ...
            <div className={style.member_center_container}>
                ...
                <ul className={memberListBox}>
                    <li className={`${memberItem} ${memberShadowBox} ${style.member_list_radius}`}>
                        <img src={icons['会员中心']} className={style.icon} />
                    会员中心
                    </li>
                    {
                        userInfoAlign === 'left' &&
                        <li className={`${memberItem} ${memberShadowBox}`}>
                         <img src={icons['我的订单']} className={style.icon} />
                        我的订单</li>
                        
                    }
                    <li className={`${memberShadowBox}`}>
                        {
