...
// debugger
import style from './CouponsPreview.css'
  ...
  singlePreiw = () => {
    ...
    return(
      <div className={style.singleCoupons}>
        <div className={style.singleCouponsLeft} style={{backgroundColor: backgroundColor}}>
        ...
        <div className={style.manyCouponsList} style={createStyle(config)}>
          {arr.map((i) =>
            <div className={style.manyCoupons} key={i}>
              <div className={style.manyCouponsLeft} style={{backgroundColor: backgroundColor}}>
                <p className={style.couponsPrice}><span>￥</span>18.8</p>
                <p className={style.couponsType}>全场满500可用</p>
              </div>
